...
import 'package:quiz_clone/screen/screen_home.dart';
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      Container(padding: EdgeInsets.fromLTRB(0, width*0.048, 0, width*0.012),
                      child: Text('수고하셨습니다!',
                        style: TextStyle(
                ...
                Container(
                  ...
                  child: ButtonTheme(minWidth: width*0.73,
                  height: height*0.05,
